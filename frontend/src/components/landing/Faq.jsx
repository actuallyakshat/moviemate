...
export const Faq = () => {
  ...
  return (
    <div className="w-full py-8 lg:py-0 bg-background border-b border-t border-foreground/20">
      <div className="w-[90%] lg:w-[70%] mx-auto lg:flex-row flex-col flex">
        ...
        >
          <h1 className="text-2xl">What is Movie Mate, again?</h1>
        </motion.div>
        ...
        >
          ...
          >
            <AccordionItem value="item-1" className="border-b-gray-400">
              ...
              <AccordionContent className="text-[1rem] text-foreground/80 tracking-tight ">
