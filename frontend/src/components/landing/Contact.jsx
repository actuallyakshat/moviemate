      ...
      <section className="bg-background">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="mb-4 text-4xl tracking-tight font-extrabold text-center text-foreground"
          >
            Contact Us
          </motion.h2>
          <motion.p
            ...
            viewport={{ once: true }}
            className="mb-8 lg:mb-16 font-[400] text-center text-foreground/80 sm:text-xl"
          >
          ...
          >
            ...
            {!loading && <Button>Send Message</Button>}
          </motion.form>
        </div>
      </section>
    </div>
