...
export const Features = () => {
  ...
  return (
    <div className="h-fit bg-featuresBg bg-background flex flex-col relative items-center">
      <motion.h1
        ...
        viewport={{ once: true }}
        className="text-2xl px-3 lg:text-5xl mt-24 font-bold tracking-wide  text-center text-foreground/90"
      >
      ...
      <div className="w-full h-full bg-background py-4 lg:py-0 lg:-mt-24">
        <div className="max-w-[75%] mx-auto flex flex-col lg:flex-row justify-center items-center lg:gap-6">
          ...
          >
            ...
            <p className="max-w-[40ch]  opacity-80">
